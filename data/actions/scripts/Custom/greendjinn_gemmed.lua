function onUse(player, item, fromPosition, target, toPosition)
    ...
    -- Verifica se o player já tem acesso aos Blue Djinns
    if player:getStorageValue(1030) == 11 then
        player:sendTextMessage(MESSAGE_INFO_DESCR, "You cannot use this lamp while having access to the Blue Djinns.")
        return false

    -- Verifica se o player ainda não tem acesso aos Green Djinns
