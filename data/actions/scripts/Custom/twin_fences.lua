local stonePosition = Position(32651, 32093, 13)
local stoneId = 1547
local leverIds = {on = 1945, off = 1946} -- 1945 = lever up, 1946 = lever down
local resetTime = 30 * 1000 -- 30 seconds in milliseconds
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if stone then
        ...
        player:say("You removed the fence! It will return in 30 seconds.", TALKTYPE_MONSTER_SAY)
