local stonePosition = Position(32326, 31718, 13)
local stoneId = 1546
local leverIds = {on = 1945, off = 1946} -- 1945 = lever up, 1946 = lever down
local resetTime = 90 * 1000 -- 30 seconds in milliseconds
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if stone then
        ...
        player:say("You removed the fence! It will return in 90 seconds. RUNNNN!!", TALKTYPE_MONSTER_SAY)
        
        -- Schedule stone to return after 30 seconds
