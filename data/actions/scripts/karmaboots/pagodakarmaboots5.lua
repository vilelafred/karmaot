local stonePosition = Position(32365, 33100, 14)
local stoneId = 1445
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if stone then
        ...
        player:say("You removed the monument! It will return in 1 hour. RUNNNN!!", TALKTYPE_MONSTER_SAY)
