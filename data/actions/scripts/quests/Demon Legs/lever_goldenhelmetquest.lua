...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	piece1pos = {x=33395, y=31543, z=11, stackpos=1} -- Where the first piece will be placed
	getpiece1 = getThingfromPos(piece1pos)
 
	piece2pos = {x=33395, y=31546, z=11, stackpos=1} -- Where the second piece will be placed
	getpiece2 = getThingfromPos(piece2pos)
 
	piece3pos = {x=33399, y=31546, z=11, stackpos=1} -- Where the third piece will be placed
	getpiece3 = getThingfromPos(piece3pos)
 
	piece4pos = {x=33399, y=31543, z=11, stackpos=1} -- Where the fourth piece will be placed
	getpiece4 = getThingfromPos(piece4pos)
 
	player1pos = {x=33405, y=31553, z=11, stackpos=253} -- Where player1 will stand before pressing lever
	player1 = getThingfromPos(player1pos)
	player2pos = {x=33404, y=31553, z=11, stackpos=253} -- Where player2 will stand before pressing lever
	player2 = getThingfromPos(player2pos)
	player3pos = {x=33403, y=31553, z=11, stackpos=253} -- Where player3 will stand before pressing lever
	player3 = getThingfromPos(player3pos)
	player4pos = {x=33402, y=31553, z=11, stackpos=253} -- Where player4 will stand before pressing lever
	...
	nplayer1pos = {x=33400, y=31577, z=11} -- The new position of player1
	nplayer2pos = {x=33399, y=31577, z=11} -- The new position of player2
	nplayer3pos = {x=33399, y=31578, z=11} -- The new position of player3
	nplayer4pos = {x=33399, y=31576, z=11} -- The new position of player4
