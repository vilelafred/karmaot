...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	local posTel = {x=32672, y=32140, z=7}
	local posBridge = {
		[1] = {x=32668, y=32137, z=7},
		[2] = {x=32671, y=32137, z=7}
		}
	local switches = {
		[1] = {x=32595, y=32107, z=8},
		[2] = {x=32596, y=32107, z=8}
		}
		
	if item.itemid == 1945 then
		doCreateItem(4825,posBridge[1])
		doCreateItem(4825,posBridge[2]) 
		for i=1,#switches do
