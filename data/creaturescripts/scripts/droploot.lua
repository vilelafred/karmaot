function onDeath(player, corpse, killer, mostDamage, unjustified, mostDamage_unjustified)
	...
	-- Check if player has all 5 basic blessings - if so, NO item loss
	...
	-- Only apply item loss if player doesn't have all 5 blessings OR has red/black skull
	if not hasAllBlessings or table.contains({SKULL_RED, SKULL_BLACK}, player:getSkull()) then
