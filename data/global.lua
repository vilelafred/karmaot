...
-- AutoLoot config
    AUTO_LOOT_MAX_ITEMS = 5 -- mmax 5? we can add that later im not able to think anymore xD 
	AUTO_LOOT_MAX_EXTRA = 5
    -- Reserved storage
    AUTOLOOT_STORAGE_START = 57000
    AUTOLOOT_STORAGE_END = AUTOLOOT_STORAGE_START + AUTO_LOOT_MAX_ITEMS + AUTO_LOOT_MAX_EXTRA -- Ends 57010
	AUTOLOOT_EXTRA_UNLOCKED = 57011
-- AutoLoot config end
