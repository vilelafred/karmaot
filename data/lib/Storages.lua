...
STORAGE_THADDEUS_DOOR = 24777 
STORAGE_PARADOX1 = 20061
STORAGE_PARADOX2 = 20062
STORAGE_PARADOX3 = 20063
STORAGE_PARADOX4 = 20064

STORAGE = {
	swordFury = 11003,
	-- Karma Elemental Stones System
	KarmaStones = {
		ActiveCount = 85000,  -- Quantidade de stones ativas
		Slot1 = 85001,        -- Primeira stone (JSON data)
		Slot2 = 85002         -- Segunda stone (JSON data)
	}
}
