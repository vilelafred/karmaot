...
SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position({x = 32280, y = 30595, z = 6}),
	rewardPosition = Position({x = 32267, y = 30574, z = 6}),
	...
	itemPillar = 1353,
	itemTeleport = 5023,
	itemsNotErasable = {1387, 1353, 2181, 2182, 2183},
}

-- Script automatically derives other pit positions from this one
local firstPit = {
	fromPos = {x = 32250, y = 30588, z = 7},
	toPos = {x = 32259, y = 30597, z = 7},
	center = {x = 32254, y = 30593, z = 7},
	pillar = {x = 32249, y = 30592, z = 7},
	tp = {x = 32249, y = 30592, z = 7},
	summon = {x = 32254, y = 30595, z = 7}
}
