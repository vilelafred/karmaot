	...
	if tileitem:getActionId() == 61112 then
		--print("aiiaia")
		if moveitem:getId() == 2153 or moveitem:getId() == 2154 or moveitem:getId() == 2155 or moveitem:getId() == 2156 or moveitem:getId() == 2158 or moveitem:getId() == 2350 or moveitem:getId() == 6215 then
		PayPos = {x=33022, y=32176, z=9}
		Item1 = getTileItemById(PayPos, 2153)
		...
		Item7 = getTileItemById(PayPos, 6215)
			...
			if Item1.itemid == 2153 and Item2.itemid == 2154 and Item3.itemid == 2155 and Item4.itemid == 2156 and Item5.itemid == 2158 and Item6.itemid == 2350 and Item7.itemid == 6215 then
