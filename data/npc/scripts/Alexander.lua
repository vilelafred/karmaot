...
--shopModule:addBuyableItem({'sudden death rune'}, 2268, 250)
--shopModule:addBuyableItem({'magic wall rune'}, 2293, 116)
--shopModule:addBuyableItem({'ultimate healing rune'}, 2273, 200)
