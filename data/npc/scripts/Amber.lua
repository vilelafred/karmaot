...
keywordHandler:addKeyword({'carlin'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Carlin, without a doubt is my favorite city!"})
keywordHandler:addKeyword({'sword of fury'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "sword of fury is the dream of many don't you think?..."})
keywordHandler:addKeyword({'minotaur'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "minotaurs are powerful creatures that have invaded rookgaad, but I feel like someone is behind it..."})
keywordHandler:addKeyword({'mission'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I have a mission on this island, and I will not fail.."})
...
keywordHandler:addKeyword({'princess'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Princesses? my favorite is definitely lumelia, it's the most powerful, do you agree?."})
