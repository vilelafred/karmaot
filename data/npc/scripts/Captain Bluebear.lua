...
local config = {
   ...
   ["ab'dendriel"] = {cost = 130, location = BOATPOS_AB},
   ["port hope"] = {cost = 160, location = BOATPOS_PORT},
   ["edron"] = {cost = 160, location = BOATPOS_EDRON},
   ["yalahar"] = {cost = 280, location = BOATPOS_YALAHAR}, 
   ["liberty bay"] = {cost = 380, location = BOATPOS_LIBERTY}    
   }
...
local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
    ...
    if msgcontains(msgLower, "bring me to") then
        -- 15 seconds cooldown for the shortcut
...
addTravelKeyword('yalahar', 280, BOATPOS_YALAHAR)
addTravelKeyword('liberty bay', 380, BOATPOS_LIBERTY)
