...
local config = {
   ["venore"] = {cost = 40, location = BOATPOS_VENORE},
   ["carlin"] = {cost = 110, location = BOATPOS_CARLIN},
   ["ankrahmun"] = {cost = 160, location = BOATPOS_ANKRAHMUN},
   ["cormaya"] = {cost = 20, location = BOATPOS_CORMAYA},
   ["ab'dendriel"] = {cost = 70, location = BOATPOS_AB},
   ["port hope"] = {cost = 150, location = BOATPOS_PORT},
...
addTravelKeyword('ankrahmun', 160, BOATPOS_ANKRAHMUN)
addTravelKeyword('carlin', 110, BOATPOS_CARLIN)
addTravelKeyword('cormaya', 20, BOATPOS_CORMAYA)
addTravelKeyword('port hope', 150, BOATPOS_PORT)
