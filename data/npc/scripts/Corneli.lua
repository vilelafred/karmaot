...
shopModule:addSellableItem({'spike sword'}, 2383, 1500)
...
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "My name is Corneli."})
