...
function creatureSayCallback(cid, type, msg)
	...
	talk_state = 2
	elseif msgcontains(msg, 'yes') and talk_state == 2 and getPlayerItemCount(cid,1955) >= 1 then
	npcHandler:say('By the gods! This is brother Fugios handwriting and what I read is horrible indeed! You have done our order a great favour by giving this diary to me! Take this blessed Ankh. May it protect you in even your darkest hours.')
	doPlayerTakeItem(cid,1955,1)
	setPlayerStorageValue(cid,99697,1)
	talk_state = 0
	else
	npcHandler:say('sorry no have book!!')
	end
return TRUE
end
