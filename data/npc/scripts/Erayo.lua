...
local config = {
	['50 pieces of blue cloth'] = {storageValue = 1, text = {'Brought the 50 pieces of blue cloth?', 'Good. Get me 50 {pieces of green cloth} now.'}, itemId = 5912, count = 50},
	['50 pieces of green cloth'] = {storageValue = 2, text = {'Brought the 50 pieces of green cloth?', 'Good. Get me 50 {pieces of red cloth} now.'}, itemId = 5910, count = 50},
	['50 pieces of red cloth'] = {storageValue = 3, text = {'Brought the 50 pieces of red cloth?', 'Good. Get me 50 {pieces of brown cloth} now.'}, itemId = 5911, count = 50},
	['50 pieces of brown cloth'] = {storageValue = 4, text = {'Brought the 50 pieces of brown cloth?', 'Good. Get me 50 {pieces of yellow cloth} now.'}, itemId = 5913, count = 50},
	['50 pieces of yellow cloth'] = {storageValue = 5, text = {'Brought the 50 pieces of yellow cloth?', 'Good. Get me 50 {pieces of white cloth} now.'}, itemId = 5914, count = 50},
	['50 pieces of white cloth'] = {storageValue = 6, text = {'Brought the 50 pieces of white cloth?', 'Good. Get me 10 {spools of yarn} now.'}, itemId = 5909, count = 50},
...
local txt = {
	[1] = '50 pieces of blue cloth',
	[2] = '50 pieces of green cloth', 
	[3] = '50 pieces of red cloth',
	[4] = '50 pieces of brown cloth',
	[5] = '50 pieces of yellow cloth',
	[6] = '50 pieces of white cloth',
	[7] = '10 spools of yarn'
}
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'addon') then
		...
		elseif player:getStorageValue(Storage.OutfitQuest.AssassinFirstAddon) < 8 then
			local message_ = txt[player:getStorageValue(Storage.OutfitQuest.AssassinFirstAddon)]
			if not message_ then return true end
			npcHandler:say(config[message_].text[1], cid)
