...
local config = {
    ...
    playerPosition = Position(32352, 32226, 5), -- player must stay on this position to talk with npc
    dicerCounter = Position(32353, 32225, 5), -- counter position {x = 32353, y = 32225, z = 5}
}
