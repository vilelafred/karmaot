...
shopModule:addBuyableItem({'life ring'}, 2168, 700)
shopModule:addBuyableItem({'ring of healing'}, 2168, 2500)
shopModule:addBuyableItem({'crystal ball'}, 2192, 530)
shopModule:addBuyableItem({'life'}, 2006, 50, 10, 'life fluid')
shopModule:addBuyableItem({'mana'}, 2006, 45, 7, 'mana fluid')
shopModule:addBuyableItem({'spellbook'}, 2175, 150)

shopModule:addBuyableItem({'antidote rune'}, 2266, 55, 1, 'antidote rune')
...
shopModule:addBuyableItem({'explosion rune','explosion'}, 2313, 170, 3, 'explosion rune')
...
shopModule:addBuyableItem({'great fireball rune','gfb'}, 2304, 160, 4, 'great fireball rune')
shopModule:addBuyableItem({'heavy magic missile rune','hmm'}, 2311, 100, 5, 'heavy magic missile rune')
...
shopModule:addBuyableItem({'sudden death rune','sd'}, 2268, 300, 1, 'sudden death rune')
shopModule:addBuyableItem({'ultimate healing rune', 'uh'}, 2273, 160, 1, 'ultimate healing rune')
...
shopModule:addBuyableItem({'magic wall rune'}, 2293, 300, 4, 'magic wall rune')
