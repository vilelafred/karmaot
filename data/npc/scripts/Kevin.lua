...
function creatureSayCallback(cid, type, msg)
	...
	npcHandler:say('Voce tem Storage Test ['..getPlayerStorageValue(cid, 2353)..'/10].')
	setPlayerStorageValue(cid,2353,getPlayerStorageValue(cid,2353)+1)
	topic = 0
	...
	setPlayerStorageValue(cid,25903,1)
	topic = 0
	...
	elseif msgcontains(msg, 'mission') and getPlayerStorageValue(cid,246) == 1 then
	...
	elseif msgcontains(msg, 'yes') and topic == 20 and getPlayerStorageValue(cid,246) == 1 then
	...
	elseif msgcontains(msg, 'mission') and getPlayerStorageValue(cid,234) > 0 and getPlayerStorageValue(cid,234) < 6 then
	...
	elseif msgcontains(msg, 'mission') and getPlayerStorageValue(cid,234) >= 6 then
	...
	elseif getPlayerStorageValue(cid,233) == 10 and getPlayerStorageValue(cid,234) < 6 and msgcontains(msg, 'mission') then
