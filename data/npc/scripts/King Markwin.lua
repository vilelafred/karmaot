...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'milk') or msgcontains(msg, 'milkk') then
	npcHandler:say('are you saying you brought my precious milk?')
	talk_state = 1
	
	elseif msgcontains(msg, 'yes') and talk_state == 1 and getPlayerItemCount(cid,2006) >= 1 then
	npcHandler:say('thanks, with this milk my power is recovering, i promise i will stop the attacks for some time! take this book as proof of our agreement..')
	doPlayerAddItem(cid, 5853)
	doPlayerRemoveItem(cid,2006,1)
	talk_state = 0
	elseif msgcontains(msg, 'yes') and talk_state == 1 and getPlayerItemCount(cid,2006) == 0 then
