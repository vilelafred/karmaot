...
keywordHandler:addKeyword({'black knight'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "how do you know about it?."})
keywordHandler:addKeyword({'brother'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "he was banished, he was unworthy of these lands."})
