...
function greetCallback(cid)
	...
	npcHandler:setMessage(MESSAGE_GREET, "Ah, 'ello, ".. getPlayerName(cid) .."! I can see you're longing for my delicious fruits, chri.")
	return true
	else
...
if msgcontains(msg, 'name') or msgcontains(msg, 'Name') then
	if getPlayerSex(cid) == 1 then
	npcHandler:say("Moi? Livielle for you, chri.", 1)
	else
