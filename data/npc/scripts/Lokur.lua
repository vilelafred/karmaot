...
----TRANSFER-------------------------------------------------------------------------
	...
	elseif msgcontains(msg, 'measurements') and getPlayerStorageValue(cid,235) < 1 then
	npcHandler:say("Come on, I have no clue what they are. Better ask my armorer Kroox for such nonsense. Go and ask him for good ol' Lokur's measurements, he'll know.")
	setPlayerStorageValue(cid,235,1)
