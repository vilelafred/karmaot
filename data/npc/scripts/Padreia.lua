...
elseif msgcontains(msg, 'invisible') or msgcontains(msg, 'Invisible') or msgcontains(msg, 'invisibility') or msgcontains(msg, 'Invisibility') then
	spellprice = 1000
...
elseif msgcontains(msg, 'firebomb') or msgcontains(msg, 'Firebomb') or msgcontains(msg, 'Fire Bomb') or msgcontains(msg, 'fire bomb') then
	spellprice = 1500
	spellvoc = {1, 2, 5, 6}
...
elseif msgcontains(msg, 'antidote rune') or msgcontains(msg, 'Antidote Rune') or msgcontains(msg, 'cure poison rune') or msgcontains(msg, 'Cure Poison Rune') then
	spellprice = 600
	spellvoc = {2, 6}
