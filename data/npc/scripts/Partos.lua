...
elseif msgcontains(msg, 'ankrahmun') or msgcontains(msg, 'Ankrahmun') then
	...
	addEvent(message33, 3000, pos)
	talk_state = 0

elseif msgcontains(msg, 'djinn') and getPlayerStorageValue(cid,1020) == 3 or msgcontains(msg, "baa'leal") and getPlayerStorageValue(cid,1020) == 3 or msgcontains(msg, 'supplies') and getPlayerStorageValue(cid,1020) == 3 or msgcontains(msg, "mal'ouquah") and getPlayerStorageValue(cid,1020) == 3 then
	npcHandler:say("What!? I bet, Baa'leal sent you! ...", 1)
	talk_state = 0
	setPlayerStorageValue(cid,1020,4)
	addEvent(message31, 3000, pos)	
...
function message33(cid, type, msg)
npcHandler:say("Unfortunately I had to relocate. <sigh> ...", 5)
addEvent(message34, 3000, pos)	
end
function message34(cid, type, msg)
