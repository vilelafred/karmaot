...
function creatureSayCallback(cid, type, msg)
	...
	npcHandler:say('Ah yes, the carlin sword is a symbol of the warriors of this city, if you have it I will recognize your courage do you carry it?.')
	talk_state = 2
	
	elseif msgcontains(msg, 'yes') and talk_state == 2 and getPlayerItemCount(cid,2395) >= 1 then
	...
	elseif msgcontains(msg, 'yes') and talk_state == 2 and getPlayerItemCount(cid,2395) == 0 then
	npcHandler:say('No')
	talk_state = 0
