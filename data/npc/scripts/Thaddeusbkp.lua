...
addSellItem({'magic plate armor'}, 2472, increasePrice(90000), 'magic plate armor')
...
addSellItem({'sword ring'}, 2207, increasePrice(100), 'sword ring')
addSellItem({'axe ring'}, 2208, increasePrice(100), 'axe ring')
addSellItem({'club ring'}, 2209, increasePrice(100), 'club ring')
...
addSellItem({'stealth ring'}, 2165, increasePrice(200), 'stealth ring')
addSellItem({'power ring'}, 2166, increasePrice(50), 'power ring')
...
addSellItem({'might ring'}, 2164, increasePrice(250), 'might ring', 20)
addSellItem({'energy ring'}, 2167, increasePrice(100), 'energy ring')
addSellItem({'life ring'}, 2168, increasePrice(50), 'life ring')
addSellItem({'time ring'}, 2169, increasePrice(100), 'time ring')
...
addSellItem({'dwarven ring'}, 2213, increasePrice(100), 'dwarven ring')
addSellItem({'ring of healing'}, 2214, increasePrice(100), 'ring of healing')
