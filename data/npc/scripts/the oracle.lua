		...
		if(getPlayerLevel(cid) < parameters.level) then
			npcHandler:say('CHILD! COME BACK WHEN YOU HAVE GROWN UP!')
                    ...
                    if (voc == 1) or (voc == 2) then  -- sorc/druid
					   local bp = doPlayerAddItem(cid, 1988, 1) -- bp
						doAddContainerItem(bp, 2120, 1) -- rope
						doAddContainerItem(bp, 2554, 1) -- shovel
						doAddContainerItem(bp, 2789, 5) -- brown mushroom
						doAddContainerItem(bp, 2457, 1) -- steel helmet
						doAddContainerItem(bp, 2463, 1) -- plate armor
						doAddContainerItem(bp, 2647, 1) -- plate legs
						doAddContainerItem(bp, 2525, 1) -- dwarven shield
						doAddContainerItem(bp, 2182, 1) -- rod druid	
						doAddContainerItem(bp, 2190, 1) -- wand sorc						
                    ...
                    elseif (voc == 4) then  -- knight
					   local bp = doPlayerAddItem(cid, 1988, 1) -- bp
						...
						doAddContainerItem(bp, 2647, 1) -- plate legs
						doAddContainerItem(bp, 2525, 1) -- dwarven shield
						doAddContainerItem(bp, 2409, 1) -- serpent sword						
                    end
