...
local chestId = 8066
local rewardItem = 2499 -- Warlord Sword
local rewardStorage = 8788 -- storage exclusivo desse baú
...
warlordChest:aid(7176) -- você pode usar actionid se preferir, ou trocar por itemid(1740)
