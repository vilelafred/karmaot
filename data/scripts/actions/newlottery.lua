local config = {
    ...
    prizePool = {
        {itemId = 6193, count = {1, 1},    chance = 2 }, -- auto sell loot
        {itemId = 8206, count = {1, 1},    chance = 10 }, -- mining pick
        {itemId = 6832, count = {1, 1},    chance = 4 }, -- multi tool
        {itemId = 6562, count = {1, 1},    chance = 2 }, -- smith hammer	
        {itemId = 6610, count = {1, 1},    chance = 1 }, -- ultimate surprise bag			
        {itemId = 6838, count = {1, 1},    chance = 3 }, -- bless scroll
        {itemId = 7731, count = {1, 1},    chance = 4 }, -- food fluid
        {itemId = 6846, count = {1, 5},    chance = 4  }, -- magic sulphur
        {itemId = 6836, count = {1, 1},    chance = 4 }, -- 100 karma ticket
        {itemId = 6606, count = {1, 1},    chance = 6 }, -- converter
        {itemId = 6692, count = {1, 1},    chance = 5 }, -- casino ticket 	
        {itemId = 7727, count = {1, 1},   chance = 3}, -- autoloot slot
        {itemId = 2160, count = {15, 30}, chance = 9 }, -- crystal coin   			
    },
	
    roulettePositions = { -- hard-coded to 7 positions.
        Position(32077, 32318, 7),
        Position(32078, 32318, 7),
        Position(32079, 32318, 7),
        Position(32080, 32318, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(32081, 32318, 7),
        Position(32082, 32318, 7),
        Position(32083, 32318, 7),
    }
}
