local config = {
    ...
    prizePool = {
        {itemId = 6181, count = {1, 1},    chance = 8 }, -- mana amulet
        {itemId = 6155, count = {1, 1},    chance = 6 }, -- training staff
        {itemId = 6698, count = {1, 1},    chance = 7 }, -- exp boost		
        {itemId = 6838, count = {1, 1},    chance = 3 }, -- bless scroll
        {itemId = 6610, count = {1, 1},    chance = 1 }, -- ultimate surprise bag			
        {itemId = 6800, count = {1, 1},    chance = 2  },  -- dragon slayer outfit
        {itemId = 6784, count = {1, 1},    chance = 1 }, -- demon knight outfit
        {itemId = 6836, count = {1, 1},    chance = 1 }, -- 100 karma points
        {itemId = 2474, count = {1, 1},    chance = 2 }, -- winged helmet	
        {itemId = 6818, count = {1, 1},    chance = 15 }, -- temple scroll
        {itemId = 6692, count = {1, 1},    chance = 15 }, -- casino ticket 	
        {itemId = 7632, count = {1, 1},   chance = 10}, -- rainbow shield 
        {itemId = 2160, count = {1, 15}, chance = 15 }, -- crystal coin   -- items with 'charges' and have 'showCharges' in items.xml will be given charges - PLATINUM COINS					
    },
	
    roulettePositions = { -- hard-coded to 7 positions.
        Position(32066, 32303, 7),
        Position(32067, 32303, 7),
        Position(32068, 32303, 7),
        Position(32069, 32303, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(32070, 32303, 7),
        Position(32071, 32303, 7),
        Position(32072, 32303, 7),
    }
}
