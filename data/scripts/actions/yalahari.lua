local rewards = {
	[22211] = {itemId = 6184, name = "Yalahari Mage Armor"},        
	[22212] = {itemId = 6187, name = "Yalahari Shooter Armor"},   
	[22213] = {itemId = 6169, name = "Yalahari King Armor"}        
}

local questStorage = 22274 -- Storage que marca se o player já pegou a recompensa
