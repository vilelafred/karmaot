...
local gainVoc = {
	[0] = {health = 5, mana = 5, magic = 1, skill = 1, cap = 10},
	[1] = {health = 5, mana = 5, magic = 1, skill = 1, cap = 10},
	[2] = {health = 5, mana = 5, magic = 1, skill = 1, cap = 10},
	[3] = {health = 5, mana = 5, magic = 1, skill = 1, cap = 10},
	[4] = {health = 5, mana = 5, magic = 1, skill = 1, cap = 10}
}
...
function Player:sendSkillPointsWindow()
    ...
    for i = 1, #skills do
        local baseVocId = self:getBaseVocId()
        -- print("BaseVocId:", baseVocId)  -- Adiciona esta linha para depurar

        if isInArray(skillForVoc[baseVocId], i) then
