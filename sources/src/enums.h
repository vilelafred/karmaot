 ...
 */
 ...
 enum ConditionParam_t {
	 ...
	 CONDITION_PARAM_SKILL_CRITICAL_HIT_CHANCE = 48,
	 CONDITION_PARAM_SKILL_CRITICAL_HIT_DAMAGE = 49,
	 CONDITION_PARAM_SKILL_LIFE_LEECH_CHANCE = 50,
	 CONDITION_PARAM_SKILL_LIFE_LEECH_AMOUNT = 51,
	 CONDITION_PARAM_SKILL_MANA_LEECH_CHANCE = 52,
	 CONDITION_PARAM_SKILL_MANA_LEECH_AMOUNT = 53,
 ...
 struct MarketOfferEx {
	 ...
	 MarketOfferEx(MarketOfferEx&& other) :
		 ...
		 playerName(std::move(other.playerName)), attrSize(other.attrSize), attr(other.attr) {}
