 ...
 */
 ...
 class IOMarket
 {
	 public:
		 ...
		 static void createOffer(uint32_t playerId, MarketAction_t action, uint32_t itemId, uint16_t amount, uint32_t price, bool anonymous, std::string description, size_t attributesSize, const char* attributes);
