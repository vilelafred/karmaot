...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTPHYSICAL)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTENERGY)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTEARTH)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTFIRE)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTLIFEDRAIN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTMANADRAIN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTHEALING)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTDROWN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTICE)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTHOLY)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTDEATH)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEPHYSICAL)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEENERGY)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEEARTH)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEFIRE)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCELIFEDRAIN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEMANADRAIN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEHEALING)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEDROWN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEICE)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEHOLY)
	registerEnum(ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEDEATH)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTPHYSICAL)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTENERGY)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTEARTH)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTFIRE)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTLIFEDRAIN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTMANADRAIN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTHEALING)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTDROWN)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTICE)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTHOLY)
	registerEnum(ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTDEATH)	
