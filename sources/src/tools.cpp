...
ItemCustomAttributes_t combatTypeToCustomBoostAttribute(CombatType_t combatType)
{
	switch (combatType) {
		case COMBAT_PHYSICALDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTPHYSICAL;
		case COMBAT_ENERGYDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTENERGY;
		case COMBAT_EARTHDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTEARTH;
		case COMBAT_FIREDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTFIRE;
		case COMBAT_LIFEDRAIN:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTLIFEDRAIN;
		case COMBAT_MANADRAIN:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTMANADRAIN;
		case COMBAT_HEALING:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTHEALING;
		case COMBAT_DROWNDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTDROWN;
		case COMBAT_ICEDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTICE;
		case COMBAT_HOLYDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTHOLY;
		case COMBAT_DEATHDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_BOOSTPERCENTDEATH;
		default:
...
ItemCustomAttributes_t combatTypeToCustomReflectPercentAttribute(CombatType_t combatType)
{
	switch (combatType) {
		case COMBAT_PHYSICALDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTPHYSICAL;
		case COMBAT_ENERGYDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTENERGY;
		case COMBAT_EARTHDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTEARTH;
		case COMBAT_FIREDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTFIRE;
		case COMBAT_LIFEDRAIN:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTLIFEDRAIN;
		case COMBAT_MANADRAIN:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTMANADRAIN;
		case COMBAT_HEALING:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTHEALING;
		case COMBAT_DROWNDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTDROWN;
		case COMBAT_ICEDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTICE;
		case COMBAT_HOLYDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTHOLY;
		case COMBAT_DEATHDAMAGE:
			return ITEM_CUSTOMATTRIBUTE_REFLECTPERCENTDEATH;
		default:
			return ITEM_CUSTOMATTRIBUTE_NONE;
	}
}
...
ItemCustomAttributes_t combatTypeToCustomReflectChanceAttribute(CombatType_t combatType)
{
	switch (combatType) {
	case COMBAT_PHYSICALDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEPHYSICAL;
	case COMBAT_ENERGYDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEENERGY;
	case COMBAT_EARTHDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEEARTH;
	case COMBAT_FIREDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEFIRE;
	case COMBAT_LIFEDRAIN:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCELIFEDRAIN;
	case COMBAT_MANADRAIN:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEMANADRAIN;
	case COMBAT_HEALING:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEHEALING;
	case COMBAT_DROWNDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEDROWN;
	case COMBAT_ICEDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEICE;
	case COMBAT_HOLYDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEHOLY;
	case COMBAT_DEATHDAMAGE:
		return ITEM_CUSTOMATTRIBUTE_REFLECTCHANCEDEATH;
	default:
		return ITEM_CUSTOMATTRIBUTE_NONE;
	}
}
